...
int	move_player(t_bvars *vars, int coords[2], int target[2]);
int	exit_reached(t_bvars *vars);
int	player_walked_into_enemy(t_bvars *vars, int coords[2], int target[2]);
